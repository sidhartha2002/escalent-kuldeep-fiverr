    ...
    >
      ...
      <main id="maincontent" className="maincontent-blocks">
        <div className="intro-content block">
          <h2 className="font-bold">Healthcare professionals</h2>
          <div className="flex flex-col pt-5 text-left text-base">
            With Healthcare Professionals from all around the world, Audience
            Match has a long experience of performing complex research
            initiatives. Healthcare IT experts, academics, researchers, nurses,
            oncologists, dermatology specialists, haematologists, medical
            professionals (PCPs), chemists, and hospital administrators and
            insurers are just a few of the many professional groups represented
            in our extensive background. We often combine both quantitative and
            qualitative methodologies in our approaches, which includes
            interviews with other tools like polls, focus groups, and deep
            interviews. By combining different types of data, we are able to get
            a complete picture of the healthcare system and provide our
            customers information they can use to make better choices and get
            better results.
            <br />
            <br />
            In addition, we are able to execute research across various
            geographical locations and healthcare systems because to our global
            network and excellent contacts with healthcare experts globally.
            Given the worldwide nature of healthcare trends and concerns in
            today's linked world, having a global perspective is very vital.
            <br />
            <br />
            <div className="font-bold">Audiences</div>
            <ul className="list-disc pl-4">
              <li>
                Professionals in the fields of oncology, dermatology,
                haematology, primary care doctors, chemists, hospital
                administrators, insurance companies, healthcare information
                technology, academics, and surgeons are among the groups we have
                spoken with.
              </li>
              <li>
                Studying patient management, technological adoption, regulatory
                environment, product and feedback evaluation, medication use and
                use, and market trends and evaluation.
              </li>
            </ul>
          </div>
          <br />
          ...
          <div className="SectionSpotlight__col SectionSpotlight__col--text">
            <div className="SectionSpotlight__text">
              ...
              <p className="SectionSpotlight__description leading-relaxed">
                Acquiring knowledge about neurologists' perspectives and
                practices on the use of pharmaceutical medicines in MS therapy.
                Only end-client contact lists will be used for recruiting.
                conducted 9,000 interviews, each lasting 20 minutes, over the
                course of 10 monthly rounds. Europe, the Americas, Asia, and the
                Middle East were among the 27 markets that were considered.
                Concentrating on a small subset of experts who have been
                extensively studied. Integrated the use of a collaborative
                network of partners.
              </p>

              <ul className="StatGrid">
                <li className="StatGrid__item">
                  <strong className="StatGrid__title">900</strong>
                  interviews of 20 minutes
                </li>
                <li className="StatGrid__item">
